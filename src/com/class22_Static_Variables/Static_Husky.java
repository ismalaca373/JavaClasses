...
public class Static_Husky {
	...
	static String breed= "Husky"; // asagida bulldoga assgin edince ondan sonra buldogg olur.
	static int paws= 4;
	static int tale=1;
  ...
  System.out.println("Puppy names is " + name + " and it is bree is " + breed);
	...
	public static void main(String[] args) {
		...
		breed = "Bulldog";  // burda dananin kuyrugu kopuyor. burda instance varibale farkli seye assign edince 
											//bundan sonra hepsini degistiri
